    ...
    "paths": {
        "/cart": {
            "get": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Cart expired or empty",
                        "schema": {
                            "type": "object",
                    ...
                    "500": {
                        "description": "No se pudo decodificar el carrito en memoria",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "saved in RAM\" model.Cart",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "cart_cleared\" model.cart",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/cart/checkout": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "success\" model.OrderStatus map[string]string map[string]string \"Checkout completado y orden pagada",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "400": {
                        "description": "failed\" model.OrderStatus map[string]string map[string]string \"Cart expired or empty",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "500": {
                        "description": "failed\" model.OrderStatus map[string]string map[string]string \"No se pudo obtener el producto para checkou",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/cart/{product_id}": {
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "item_removed\" model.Cart",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.updateCartItemRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "item_updated\" model.Cart",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/categories/{id}": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "UUID invalido o error al eliminar",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
            ...
            "patch": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "UUID/JSON invalido",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/orders/{id}": {
            ...
            "patch": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "UUID invalido o error al actualizar",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/orders/{id}/pay": {
            "patch": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "UUID invalido o error al pagar",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
